<!--
 * @Author: coco
 * @Date: 2020-04-12 14:04:55
 * @LastEditTime: 2020-04-13 22:52:41
 * @LastEditors: coco
 * @Description: 
    ...
    return {
      ...
      addFormRules: {
        ...
        email: [
          ...
          { validator: checkEmail, trigger: 'blur' } //验证自定义校验规则
        ],
        mobile: [
          { required: true, message: '请输入手机', trigger: 'blur' },
          { validator: checkMobile, trigger: 'blur' } //验证自定义校验规则
        ]
      },
      //控制修改用户对话框的显示与隐藏
